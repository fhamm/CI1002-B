...
CFLAGS = -Wall -Werror
LFLAGS = -lm
PKG = $(shell pkg-config allegro-5 allegro_font-5 allegro_image-5 allegro_primitives-5 --libs --cflags)
...
Redshift: src/Redshift.o src/Chunks.o src/Physics.o src/Entities.o
		$(CC) -o redshift src/Redshift.o src/Entities.o src/Chunks.o src/Physics.o $(PKG) $(CFLAGS) $(LFLAGS)
